  ...
  (0, _createClass2.default)(BlockCompare, [{
    ...
    value: function getOriginalContent(block) {
      ...
      return {
        ...
        renderedContent: (0, _blocks.getSaveElement)(blockType, block.attributes)
      };
    }
  }, {
    ...
    value: function getConvertedContent(block) {
      ...
      var newContent = newBlocks.map(function (item) {
        return (0, _blocks.getSaveContent)((0, _blocks.getBlockType)(item.name), item.attributes, item.innerBlocks);
      });
      var renderedContent = newBlocks.map(function (item) {
        return (0, _blocks.getSaveElement)((0, _blocks.getBlockType)(item.name), item.attributes, item.innerBlocks);
      });
      return {
