...
var unregisterBlockStyle = function unregisterBlockStyle(blockName, styleVariationName) {
  (0, _hooks.addFilter)('blocks.registerBlockType', "".concat(blockName, "/").concat(styleVariationName, "/unregister"), function (settings, name) {
    if (blockName !== name) {
      return settings;
    }

    return (0, _objectSpread2.default)({}, settings, {
      styles: (0, _lodash.reject)((0, _lodash.get)(settings, ['styles'], []), {
