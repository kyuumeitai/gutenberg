...
var _editorGlobalKeyboardShortcuts = require("../editor-global-keyboard-shortcuts");
    ...
    return (0, _element.createElement)(_components.Dropdown, {
      ...
      renderToggle: function renderToggle(_ref3) {
        var onToggle = _ref3.onToggle,
            isOpen = _ref3.isOpen;
        var toggleClassname = (0, _classnames.default)('editor-block-settings-menu__toggle', {
          'is-opened': isOpen
        });
      ...
      renderContent: function renderContent(_ref4) {
        ...
        return (0, _element.createElement)(_components.NavigableMenu, {
          ...
          onClick: onDuplicate,
          icon: "admin-page",
          shortcut: _editorGlobalKeyboardShortcuts.shortcuts.duplicate.display
          ...
          icon: "insert-before",
          shortcut: _editorGlobalKeyboardShortcuts.shortcuts.insertBefore.display
        }, (0, _i18n.__)('Insert Before')), (0, _element.createElement)(_components.MenuItem, {
          className: "editor-block-settings-menu__control",
          onClick: onInsertAfter,
          icon: "insert-after",
          shortcut: _editorGlobalKeyboardShortcuts.shortcuts.insertAfter.display
        }, (0, _i18n.__)('Insert After'))), count === 1 && (0, _element.createElement)(_blockModeToggle.default, {
          clientId: firstBlockClientId,
          onToggle: onClose
        }), (0, _element.createElement)(_reusableBlockConvertButton.default, {
          clientIds: clientIds,
          onToggle: onClose
        ...
        }), count === 1 && (0, _element.createElement)(_reusableBlockDeleteButton.default, {
          clientId: firstBlockClientId,
          onToggle: onClose
          ...
          onClick: onRemove,
          icon: "trash",
          shortcut: _editorGlobalKeyboardShortcuts.shortcuts.removeBlock.display
