...
var findBlock = function findBlock(url) {
  var _arr = (0, _toConsumableArray2.default)(_coreEmbeds.common).concat((0, _toConsumableArray2.default)(_coreEmbeds.others));
...
var isFromWordPress = function isFromWordPress(html) {
  return (0, _lodash.includes)(html, 'class="wp-embedded-content" data-secret');
};
