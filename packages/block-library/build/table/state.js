...
function insertRow(state, _ref4) {
  ...
  return (0, _defineProperty2.default)({}, section, (0, _toConsumableArray2.default)(state[section].slice(0, rowIndex)).concat([{
...
function insertColumn(state, _ref8) {
  ...
  return (0, _defineProperty2.default)({}, section, state[section].map(function (row) {
    return {
      cells: (0, _toConsumableArray2.default)(row.cells.slice(0, columnIndex)).concat([{
        content: '',
        tag: 'td'
