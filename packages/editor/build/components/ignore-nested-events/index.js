...
function (_Component) {
  ...
  (0, _createClass2.default)(IgnoreNestedEvents, [{
    ...
    value: function render() {
      ...
      var eventHandlers = (0, _lodash.reduce)((0, _toConsumableArray2.default)(childHandledEvents).concat((0, _toConsumableArray2.default)(Object.keys(props))), function (result, key) {
