...
function (_Component) {
  ...
  (0, _createClass2.default)(PostLockedModal, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _jquery.default)(document).on('heartbeat-send.refresh-lock', this.sendPostLock).on('heartbeat-tick.refresh-lock', this.receivePostLock);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      (0, _jquery.default)(document).off('heartbeat-send.refresh-lock', this.sendPostLock).off('heartbeat-tick.refresh-lock', this.receivePostLock);
    }
    /**
    ...
    value: function render() {
      ...
      var allPosts = (0, _url2.getWPAdminURL)('edit.php');
      ...
      (0, _i18n.__)('%s now has editing control of this post. Don\'t worry, your changes up to this moment have been saved'), userDisplayName) :
      /* translators: 'post' is generic and may be of any type (post, page, etc.). */
      (0, _i18n.__)('Another user now has editing control of this post. Don\'t worry, your changes up to this moment have been saved')), (0, _element.createElement)("p", null, (0, _element.createElement)("a", {
        href: allPosts
      }, (0, _i18n.__)('View all posts')))), !isTakeover && (0, _element.createElement)("div", null, (0, _element.createElement)("div", null, userDisplayName ? (0, _i18n.sprintf)(
      /* translators: 'post' is generic and may be of any type (post, page, etc.). */
      (0, _i18n.__)('%s is currently working on this post, which means you cannot make changes, unless you take over.'), userDisplayName) :
      /* translators: 'post' is generic and may be of any type (post, page, etc.). */
      (0, _i18n.__)('Another user is currently working on this post, which means you cannot make changes, unless you take over.')), (0, _element.createElement)("div", {
        className: "editor-post-locked-modal__buttons"
      }, (0, _element.createElement)(_components.Button, {
        isDefault: true,
        isLarge: true,
        href: allPosts
      }, (0, _i18n.__)('All Posts')), (0, _element.createElement)(_postPreviewButton.default, null), (0, _element.createElement)(_components.Button, {
        isPrimary: true,
        isLarge: true,
        href: unlockUrl
