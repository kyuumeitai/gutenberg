...
function PostFeaturedImage(_ref) {
  ...
  return (0, _element.createElement)(_check.default, null, (0, _element.createElement)("div", {
  ...
  }, !!featuredImageId && (0, _element.createElement)(_mediaUpload.default, {
    ...
    render: function render(_ref2) {
      ...
      return (0, _element.createElement)(_components.Button, {
        ...
        onClick: open,
        "aria-label": (0, _i18n.__)('Edit or update the image')
      }, media && (0, _element.createElement)(_components.ResponsiveWrapper, {
        naturalWidth: mediaWidth,
        naturalHeight: mediaHeight
      }, (0, _element.createElement)("img", {
        src: mediaSourceUrl,
        alt: ""
      })), !media && (0, _element.createElement)(_components.Spinner, null));
    },
    value: featuredImageId
  }), !!featuredImageId && media && !media.isLoading && (0, _element.createElement)(_mediaUpload.default, {
    title: postLabel.featured_image || DEFAULT_FEATURE_IMAGE_LABEL,
    onSelect: onUpdateImage,
    allowedTypes: ALLOWED_MEDIA_TYPES,
    modalClass: "editor-post-featured-image__media-modal",
  ...
  }), !featuredImageId && (0, _element.createElement)("div", null, (0, _element.createElement)(_mediaUpload.default, {
    title: postLabel.featured_image || DEFAULT_FEATURE_IMAGE_LABEL,
    onSelect: onUpdateImage,
    allowedTypes: ALLOWED_MEDIA_TYPES,
    modalClass: "editor-post-featured-image__media-modal",
  ...
  })), !!featuredImageId && (0, _element.createElement)(_components.Button, {
