    ...
    return createElement(Dropdown, {
      ...
      renderToggle: function renderToggle(_ref3) {
        var onToggle = _ref3.onToggle,
            isOpen = _ref3.isOpen;
        var toggleClassname = classnames('editor-block-settings-menu__toggle', {
          'is-opened': isOpen
        });
      ...
      renderContent: function renderContent(_ref4) {
        ...
        return createElement(NavigableMenu, {
        ...
        }, createElement(_BlockSettingsMenuFirstItem.Slot, {
          fillProps: {
            onClose: onClose
          }
          ...
          clientId: firstBlockClientId,
          onToggle: onClose
        }), createElement(ReusableBlockConvertButton, {
          clientIds: clientIds,
          onToggle: onClose
        }), createElement(_BlockSettingsMenuPluginsExtension.Slot, {
          fillProps: {
            clientIds: clientIds,
            onClose: onClose
          }
        ...
        }), count === 1 && createElement(ReusableBlockDeleteButton, {
          clientId: firstBlockClientId,
          onToggle: onClose
