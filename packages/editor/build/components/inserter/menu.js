...
var _inlineElements = _interopRequireDefault(require("./inline-elements"));
  ...
  (0, _createClass2.default)(InserterMenu, [{
    ...
    value: function onTogglePanel(panel) {
      ...
      return function () {
        ...
        if (isOpened) {
          ...
          _this3.setState({
            openPanels: (0, _toConsumableArray2.default)(_this3.state.openPanels).concat([panel])
          });
    ...
    value: function filter() {
      ...
      if (filterValue !== this.state.filterValue) {
        if (!filterValue) {
          ...
          var firstCategory = (0, _lodash.find)((0, _blocks.getCategories)(), function (_ref2) {
            var slug = _ref2.slug;
    ...
    value: function render() {
      ...
      return (0, _element.createElement)("div", {
        ...
        onSelect: onSelect,
        onHover: this.onHover
      })), (0, _element.createElement)(_inlineElements.default, {
        filterValue: filterValue
...
var _default = (0, _compose.compose)((0, _data.withSelect)(function (select, _ref3) {
  ...
  return {
    ...
    onSelect: function onSelect(item) {
      ...
      if (selectedBlock && (0, _blocks.isUnmodifiedDefaultBlock)(selectedBlock)) {
