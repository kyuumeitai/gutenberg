...
function defaultGetBlockInsertionParentClientId() {
  return (0, _data.select)('core/editor').getBlockInsertionPoint().rootClientId;
}
/**
...
function defaultGetInserterItems(rootClientId) {
  return (0, _data.select)('core/editor').getInserterItems(rootClientId);
}
/**
...
function defaultGetSelectedBlockName() {
  var selectedBlock = (0, _data.select)('core/editor').getSelectedBlock();
...
function createBlockCompleter() {
  ...
  return {
    ...
    getOptionKeywords: function getOptionKeywords(inserterItem) {
      ...
      return (0, _toConsumableArray2.default)(keywords).concat([title]);
    },
