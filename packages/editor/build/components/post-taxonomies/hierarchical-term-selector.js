...
function (_Component) {
  ...
  (0, _createClass2.default)(HierarchicalTermSelector, [{
    ...
    value: function onChange(event) {
      ...
      var newTerms = hasTerm ? (0, _lodash.without)(terms, termId) : (0, _toConsumableArray2.default)(terms).concat([termId]);
    ...
    value: function onAddTerm(event) {
      ...
      if (existingTerm) {
        ...
        if (!(0, _lodash.some)(terms, function (term) {
          ...
          onUpdateTerms((0, _toConsumableArray2.default)(terms).concat([existingTerm.id]), taxonomy.rest_base);
        }
      ...
      findOrCreatePromise.then(function (term) {
        ...
        onUpdateTerms((0, _toConsumableArray2.default)(terms).concat([term.id]), taxonomy.rest_base);
      }, function (xhr) {
    ...
    value: function render() {
      ...
      var filterLabel = (0, _i18n.sprintf)((0, _i18n._x)('Search %s', 'term'), (0, _lodash.get)(this.props.taxonomy, ['name'], slug === 'category' ? (0, _i18n.__)('Categories') : (0, _i18n.__)('Terms')));
      var groupLabel = (0, _i18n.sprintf)((0, _i18n._x)('Available %s', 'term'), (0, _lodash.get)(this.props.taxonomy, ['name'], slug === 'category' ? (0, _i18n.__)('Categories') : (0, _i18n.__)('Terms')));
