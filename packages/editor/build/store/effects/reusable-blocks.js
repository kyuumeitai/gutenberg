      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _utils.resolveSelector)('core', 'getPostType', 'wp_block');
          ...
          case 11:
            ...
            dispatch((0, _actions.__experimentalReceiveReusableBlocks)((0, _lodash.map)((0, _lodash.castArray)(reusableBlockOrBlocks), function (post) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            reusableBlock = (0, _selectors.getBlock)(state, clientId);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 10:
            ...
            allBlocks = (0, _selectors.getBlocks)(getState());
            ...
            dispatch((0, _actions.removeBlocks)((0, _toConsumableArray2.default)(associatedBlockClientIds).concat([reusableBlock.clientId])));
            _context3.prev = 16;
            _context3.next = 19;
            return (0, _apiFetch.default)({
...
var receiveReusableBlocks = function receiveReusableBlocks(action) {
  return (0, _actions.receiveBlocks)((0, _lodash.map)(action.results, 'parsedBlock'));
};
/**
...
var convertBlockToStatic = function convertBlockToStatic(action, store) {
  ...
  var oldBlock = (0, _selectors.getBlock)(state, action.clientId);
  var reusableBlock = (0, _selectors.__experimentalGetReusableBlock)(state, oldBlock.attributes.ref);
  var referencedBlock = (0, _selectors.getBlock)(state, reusableBlock.clientId);
  var newBlocks;
  ...
  store.dispatch((0, _actions.replaceBlocks)(oldBlock.clientId, newBlocks));
};
/**
...
var convertBlockToReusable = function convertBlockToReusable(action, store) {
  ...
  if (action.clientIds.length === 1) {
    parsedBlock = (0, _selectors.getBlock)(getState(), action.clientIds[0]);
  } else {
    parsedBlock = (0, _blocks.createBlock)('core/template', {}, (0, _selectors.getBlocksByClientId)(getState(), action.clientIds)); // This shouldn't be necessary but at the moment
    // we expect the content of the shared blocks to live in the blocks state.

    dispatch((0, _actions.receiveBlocks)([parsedBlock]));
  }
  ...
  dispatch((0, _actions.replaceBlocks)(action.clientIds, (0, _blocks.createBlock)('core/block', {
