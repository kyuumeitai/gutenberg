...
import { getBlock, getBlockRootClientId, getBlocks, getBlockCount, getPreviousBlockClientId, getSelectedBlock, getTemplate, getTemplateLock, isValidTemplate } from './selectors';
...
export default {
  ...
  SETUP_EDITOR: function SETUP_EDITOR(action, store) {
    ...
    var blocks = parse(post.content.raw); // Apply a template for new posts only, if exists.
    ...
    var setupAction = setupEditorState(post, blocks, edits);
